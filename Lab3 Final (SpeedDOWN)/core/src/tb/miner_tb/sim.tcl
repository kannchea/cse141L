...
add wave    -noupdate   -group {decode}           	-radix hexadecimal  /miner_tb/dut/core1/decode/instruction_i
add wave    -noupdate   -group {decode}           	-radix hexadecimal  /miner_tb/dut/core1/decode/is_load_op_o
add wave    -noupdate   -group {decode}           	-radix hexadecimal  /miner_tb/dut/core1/decode/op_writes_rf_o
add wave    -noupdate   -group {decode}           	-radix hexadecimal  /miner_tb/dut/core1/decode/is_store_op_o
add wave    -noupdate   -group {decode}           	-radix hexadecimal  /miner_tb/dut/core1/decode/is_mem_op_o
add wave    -noupdate   -group {decode}           	-radix hexadecimal  /miner_tb/dut/core1/decode/is_byte_op_o
